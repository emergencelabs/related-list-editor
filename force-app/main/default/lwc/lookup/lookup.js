...
export default class Lookup extends LightningElement {
  ...
  hasSelection() {
    return this._curSelection.length > 0 && this._curSelection[0];
  }
  ...
  processSelectionUpdate(isUserInteraction) {
    ...
    window.console.log(this._curSelection);
  ...
  get getInputValue() {
    ...
    return this.hasSelection() && this._curSelection[0]
